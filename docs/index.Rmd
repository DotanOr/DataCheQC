...
-   Hover over the info icon - ![](www/circle-info-solid.svg "Hover over me for more info!"){#hover-icon width="21"} - which appears next to most features to show an informative tooltip about that feature and what to look for during QC.
